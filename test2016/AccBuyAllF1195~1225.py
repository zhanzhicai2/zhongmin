...
mond = [1190, 1191, 1192, 1193, 1224, 1225]
AccBuyAll = webdriver.Chrome()
for i in mond:
    AccBuyAll.get('http://test2016.4008822300.net.cn/accid/Product/accident%s.html' % i)
    ...
    sltRel1 = AccBuyAll.find_element_by_id('meJob1')
    Select(sltRel1).select_by_value('1')
    meJob2 = AccBuyAll.find_element_by_id('meJob2')
    Select(meJob2).select_by_value('23')
    meJob3 = AccBuyAll.find_element_by_id('meJob3')
    Select(meJob3).select_by_value('  000101-1')
