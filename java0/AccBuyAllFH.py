...
for i in mond:
    ...
    AccBuyAll.find_element_by_id('txtPostCode').send_keys('554400')
    AccBuyAll.find_element_by_id('sltProvinceSpan').click()
    AccBuyAll.find_element_by_xpath('//*[@id="sltProvince"]/li[2]').click()
    AccBuyAll.find_element_by_id('sltCitySpan').click()
    AccBuyAll.find_element_by_xpath('//*[@id="sltCity"]/li[1]').click()
    AccBuyAll.find_element_by_id('stxtAddress').send_keys('南山区白石洲塘头村五坊65号')
