...
broweb.find_element_by_id('holdersub1').click()
# brd= broweb.find_element_by_xpath(".//*[@id='shouqi']")


# broweb.find_element_by_class_name('shouqi').click()
# broweb.find_element_by_id('in1_6476313').click()
...
# ids=['holdersub0','in1_6476313','btnpostdate','agree','imgBuy']
